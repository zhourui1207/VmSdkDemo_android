...
public class H264SPSPaser {
    ...
    public short ue(byte[] data, int StartBit) {
        ...
        Log.d(TAG, "ue leadingZeroBits = " + leadingZeroBits + ",Math.pow(2, leadingZeroBits) = "
                + Math.pow(2, leadingZeroBits) + ",tempStartBit = " + tempStartBit);
    ...
    public void addStartBit(int bit) {
        startBit += bit;
    }
