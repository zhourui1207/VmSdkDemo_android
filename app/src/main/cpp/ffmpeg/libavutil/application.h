...
struct AVApplicationContext {
    ...
    /**< information for av_log(). Set by av_application_open(). */
    void *opaque;

    /**< user data. */

    void (*func_did_tcp_connect_ip_port)(AVApplicationContext *h, int error, int family,
...
void av_application_did_tcp_connect_ip_port(AVApplicationContext *h, int error, int family,
                                            const char *ip, int port);
...
void av_application_did_http_open(AVApplicationContext *h, void *obj, const char *url, int error,
                                  int http_code);

void av_application_will_http_seek(AVApplicationContext *h, void *obj, const char *url,
                                   int64_t offset);

void av_application_did_http_seek(AVApplicationContext *h, void *obj, const char *url,
