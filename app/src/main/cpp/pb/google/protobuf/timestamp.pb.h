...
// source: pb.google/protobuf/timestamp.proto
...
class LIBPROTOBUF_EXPORT Timestamp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.Timestamp) */ {
 public:
  Timestamp();
  virtual ~Timestamp();
  ...
  // @@protoc_insertion_point(class_scope:pb.google.protobuf.Timestamp)
 private:
...
inline ::google::protobuf::int64 Timestamp::seconds() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Timestamp.seconds)
  return seconds_;
}
inline void Timestamp::set_seconds(::google::protobuf::int64 value) {
  
  seconds_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Timestamp.seconds)
}
...
inline ::google::protobuf::int32 Timestamp::nanos() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Timestamp.nanos)
  return nanos_;
}
inline void Timestamp::set_nanos(::google::protobuf::int32 value) {
  
  nanos_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Timestamp.nanos)
}
