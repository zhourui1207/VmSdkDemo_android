...
// source: pb.google/protobuf/type.proto
...
class LIBPROTOBUF_EXPORT Type : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.Type) */ {
 public:
  Type();
  virtual ~Type();
  ...
  // repeated .pb.google.protobuf.Field fields = 2;
  ...
  // repeated .pb.google.protobuf.Option options = 4;
  ...
  // .pb.google.protobuf.SourceContext source_context = 5;
...
class LIBPROTOBUF_EXPORT Field : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.Field) */ {
 public:
  Field();
  virtual ~Field();
  ...
  // repeated .pb.google.protobuf.Option options = 9;
  int options_size() const;
  void clear_options();
  ...
  // @@protoc_insertion_point(class_scope:pb.google.protobuf.Field)
 private:
...
class LIBPROTOBUF_EXPORT Enum : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.Enum) */ {
 public:
  Enum();
  virtual ~Enum();
  ...
  // repeated .pb.google.protobuf.EnumValue enumvalue = 2;
  ...
  // repeated .pb.google.protobuf.Option options = 3;
  int options_size() const;
  void clear_options();
  ...
  // .pb.google.protobuf.SourceContext source_context = 4;
  bool has_source_context() const;
  void clear_source_context();
  ...
  // .pb.google.protobuf.Syntax syntax = 5;
  void clear_syntax();
  static const int kSyntaxFieldNumber = 5;
  ::google::protobuf::Syntax syntax() const;
  void set_syntax(::google::protobuf::Syntax value);

  // @@protoc_insertion_point(class_scope:pb.google.protobuf.Enum)
 private:
...
class LIBPROTOBUF_EXPORT EnumValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.EnumValue) */ {
 public:
  EnumValue();
  virtual ~EnumValue();
  ...
  // @@protoc_insertion_point(class_scope:pb.google.protobuf.EnumValue)
 private:
...
class LIBPROTOBUF_EXPORT Option : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.Option) */ {
 public:
  Option();
  virtual ~Option();
  ...
  // .pb.google.protobuf.Any value = 2;
  ...
  // @@protoc_insertion_point(class_scope:pb.google.protobuf.Option)
 private:
...
inline const ::std::string& Type::name() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Type.name)
  return name_.Get();
}
inline void Type::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Type.name)
}
inline void Type::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Type.name)
}
inline void Type::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Type.name)
}
inline ::std::string* Type::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Type.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Type::release_name() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Type.name)
  
  return name_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Type::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.Type.name)
...
inline void Type::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Type.name)
}
inline void Type::unsafe_arena_set_allocated_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.Type.name)
}
...
inline const ::google::protobuf::Field& Type::fields(int index) const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Type.fields)
  return fields_.Get(index);
}
inline ::google::protobuf::Field* Type::mutable_fields(int index) {
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Type.fields)
  return fields_.Mutable(index);
}
inline ::google::protobuf::Field* Type::add_fields() {
  // @@protoc_insertion_point(field_add:pb.google.protobuf.Type.fields)
  return fields_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Field >*
Type::mutable_fields() {
  // @@protoc_insertion_point(field_mutable_list:pb.google.protobuf.Type.fields)
  return &fields_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Field >&
Type::fields() const {
  // @@protoc_insertion_point(field_list:pb.google.protobuf.Type.fields)
  return fields_;
}
...
inline const ::std::string& Type::oneofs(int index) const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Type.oneofs)
  return oneofs_.Get(index);
}
inline ::std::string* Type::mutable_oneofs(int index) {
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Type.oneofs)
  return oneofs_.Mutable(index);
}
inline void Type::set_oneofs(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Type.oneofs)
...
inline void Type::set_oneofs(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  oneofs_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Type.oneofs)
}
inline void Type::set_oneofs(int index, const char* value, size_t size) {
  oneofs_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Type.oneofs)
}
inline ::std::string* Type::add_oneofs() {
  // @@protoc_insertion_point(field_add_mutable:pb.google.protobuf.Type.oneofs)
  return oneofs_.Add();
}
inline void Type::add_oneofs(const ::std::string& value) {
  oneofs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:pb.google.protobuf.Type.oneofs)
}
#if LANG_CXX11
...
inline void Type::add_oneofs(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  oneofs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:pb.google.protobuf.Type.oneofs)
}
inline void Type::add_oneofs(const char* value, size_t size) {
  oneofs_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:pb.google.protobuf.Type.oneofs)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
Type::oneofs() const {
  // @@protoc_insertion_point(field_list:pb.google.protobuf.Type.oneofs)
  return oneofs_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Type::mutable_oneofs() {
  // @@protoc_insertion_point(field_mutable_list:pb.google.protobuf.Type.oneofs)
  return &oneofs_;
}
...
inline const ::google::protobuf::Option& Type::options(int index) const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Type.options)
  return options_.Get(index);
}
inline ::google::protobuf::Option* Type::mutable_options(int index) {
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Type.options)
  return options_.Mutable(index);
}
inline ::google::protobuf::Option* Type::add_options() {
  // @@protoc_insertion_point(field_add:pb.google.protobuf.Type.options)
  return options_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >*
Type::mutable_options() {
  // @@protoc_insertion_point(field_mutable_list:pb.google.protobuf.Type.options)
  return &options_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >&
Type::options() const {
  // @@protoc_insertion_point(field_list:pb.google.protobuf.Type.options)
  return options_;
}
...
inline const ::google::protobuf::SourceContext& Type::source_context() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Type.source_context)
...
inline ::google::protobuf::SourceContext* Type::mutable_source_context() {
  ...
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Type.source_context)
  return source_context_;
}
inline ::google::protobuf::SourceContext* Type::release_source_context() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Type.source_context)
...
inline  void Type::set_allocated_source_context(::google::protobuf::SourceContext* source_context) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Type.source_context)
}
...
inline ::google::protobuf::Syntax Type::syntax() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Type.syntax)
  return static_cast< ::google::protobuf::Syntax >(syntax_);
}
inline void Type::set_syntax(::google::protobuf::Syntax value) {
  
  syntax_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Type.syntax)
}
...
inline ::google::protobuf::Field_Kind Field::kind() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.kind)
  return static_cast< ::google::protobuf::Field_Kind >(kind_);
}
inline void Field::set_kind(::google::protobuf::Field_Kind value) {
  
  kind_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.kind)
}
...
inline ::google::protobuf::Field_Cardinality Field::cardinality() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.cardinality)
...
inline void Field::set_cardinality(::google::protobuf::Field_Cardinality value) {
  ...
  cardinality_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.cardinality)
}
...
inline ::google::protobuf::int32 Field::number() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.number)
  return number_;
}
inline void Field::set_number(::google::protobuf::int32 value) {
  
  number_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.number)
}
...
inline const ::std::string& Field::name() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.name)
  return name_.Get();
}
inline void Field::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.name)
}
inline void Field::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Field.name)
}
inline void Field::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Field.name)
}
inline ::std::string* Field::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Field.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Field::release_name() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Field.name)
  
  return name_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Field::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.Field.name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void Field::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Field.name)
}
inline void Field::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      name, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.Field.name)
}
...
inline const ::std::string& Field::type_url() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.type_url)
...
inline void Field::set_type_url(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.type_url)
}
inline void Field::set_type_url(const char* value) {
  ...
  type_url_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Field.type_url)
}
inline void Field::set_type_url(const char* value,
    size_t size) {
  ...
  type_url_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Field.type_url)
}
inline ::std::string* Field::mutable_type_url() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Field.type_url)
  return type_url_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Field::release_type_url() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Field.type_url)
...
inline ::std::string* Field::unsafe_arena_release_type_url() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.Field.type_url)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void Field::set_allocated_type_url(::std::string* type_url) {
  ...
  type_url_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), type_url,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Field.type_url)
}
inline void Field::unsafe_arena_set_allocated_type_url(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.Field.type_url)
}
...
inline ::google::protobuf::int32 Field::oneof_index() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.oneof_index)
  return oneof_index_;
}
inline void Field::set_oneof_index(::google::protobuf::int32 value) {
  
  oneof_index_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.oneof_index)
}
...
inline bool Field::packed() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.packed)
  return packed_;
}
inline void Field::set_packed(bool value) {
  
  packed_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.packed)
}
...
inline const ::google::protobuf::Option& Field::options(int index) const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.options)
  return options_.Get(index);
}
inline ::google::protobuf::Option* Field::mutable_options(int index) {
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Field.options)
  return options_.Mutable(index);
}
inline ::google::protobuf::Option* Field::add_options() {
  // @@protoc_insertion_point(field_add:pb.google.protobuf.Field.options)
  return options_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >*
Field::mutable_options() {
  // @@protoc_insertion_point(field_mutable_list:pb.google.protobuf.Field.options)
  return &options_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >&
Field::options() const {
  // @@protoc_insertion_point(field_list:pb.google.protobuf.Field.options)
  return options_;
}
...
inline const ::std::string& Field::json_name() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.json_name)
...
inline void Field::set_json_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.json_name)
}
inline void Field::set_json_name(const char* value) {
  ...
  json_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Field.json_name)
}
inline void Field::set_json_name(const char* value,
    size_t size) {
  ...
  json_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Field.json_name)
}
inline ::std::string* Field::mutable_json_name() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Field.json_name)
  return json_name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Field::release_json_name() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Field.json_name)
...
inline ::std::string* Field::unsafe_arena_release_json_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.Field.json_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void Field::set_allocated_json_name(::std::string* json_name) {
  ...
  json_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), json_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Field.json_name)
}
inline void Field::unsafe_arena_set_allocated_json_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.Field.json_name)
}
...
inline const ::std::string& Field::default_value() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Field.default_value)
...
inline void Field::set_default_value(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Field.default_value)
}
inline void Field::set_default_value(const char* value) {
  ...
  default_value_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Field.default_value)
}
inline void Field::set_default_value(const char* value,
    size_t size) {
  ...
  default_value_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Field.default_value)
}
inline ::std::string* Field::mutable_default_value() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Field.default_value)
  return default_value_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Field::release_default_value() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Field.default_value)
...
inline ::std::string* Field::unsafe_arena_release_default_value() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.Field.default_value)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void Field::set_allocated_default_value(::std::string* default_value) {
  ...
  default_value_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), default_value,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Field.default_value)
}
inline void Field::unsafe_arena_set_allocated_default_value(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.Field.default_value)
}
...
inline const ::std::string& Enum::name() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Enum.name)
  return name_.Get();
}
inline void Enum::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Enum.name)
}
inline void Enum::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Enum.name)
}
inline void Enum::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Enum.name)
}
inline ::std::string* Enum::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Enum.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Enum::release_name() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Enum.name)
  
  return name_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Enum::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.Enum.name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void Enum::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Enum.name)
}
inline void Enum::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      name, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.Enum.name)
}
...
inline const ::google::protobuf::EnumValue& Enum::enumvalue(int index) const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Enum.enumvalue)
  return enumvalue_.Get(index);
}
inline ::google::protobuf::EnumValue* Enum::mutable_enumvalue(int index) {
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Enum.enumvalue)
  return enumvalue_.Mutable(index);
}
inline ::google::protobuf::EnumValue* Enum::add_enumvalue() {
  // @@protoc_insertion_point(field_add:pb.google.protobuf.Enum.enumvalue)
  return enumvalue_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::EnumValue >*
Enum::mutable_enumvalue() {
  // @@protoc_insertion_point(field_mutable_list:pb.google.protobuf.Enum.enumvalue)
  return &enumvalue_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::EnumValue >&
Enum::enumvalue() const {
  // @@protoc_insertion_point(field_list:pb.google.protobuf.Enum.enumvalue)
  return enumvalue_;
}
...
inline const ::google::protobuf::Option& Enum::options(int index) const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Enum.options)
  return options_.Get(index);
}
inline ::google::protobuf::Option* Enum::mutable_options(int index) {
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Enum.options)
  return options_.Mutable(index);
}
inline ::google::protobuf::Option* Enum::add_options() {
  // @@protoc_insertion_point(field_add:pb.google.protobuf.Enum.options)
  return options_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >*
Enum::mutable_options() {
  // @@protoc_insertion_point(field_mutable_list:pb.google.protobuf.Enum.options)
  return &options_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >&
Enum::options() const {
  // @@protoc_insertion_point(field_list:pb.google.protobuf.Enum.options)
  return options_;
}
...
inline const ::google::protobuf::SourceContext& Enum::source_context() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Enum.source_context)
  return source_context_ != NULL ? *source_context_
                         : *::google::protobuf::SourceContext::internal_default_instance();
}
inline ::google::protobuf::SourceContext* Enum::mutable_source_context() {
  ...
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Enum.source_context)
  return source_context_;
}
inline ::google::protobuf::SourceContext* Enum::release_source_context() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Enum.source_context)
...
inline  void Enum::set_allocated_source_context(::google::protobuf::SourceContext* source_context) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Enum.source_context)
}
...
inline ::google::protobuf::Syntax Enum::syntax() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Enum.syntax)
  return static_cast< ::google::protobuf::Syntax >(syntax_);
}
inline void Enum::set_syntax(::google::protobuf::Syntax value) {
  
  syntax_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Enum.syntax)
}
...
inline const ::std::string& EnumValue::name() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.EnumValue.name)
  return name_.Get();
}
inline void EnumValue::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:pb.google.protobuf.EnumValue.name)
}
inline void EnumValue::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.EnumValue.name)
}
inline void EnumValue::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.EnumValue.name)
}
inline ::std::string* EnumValue::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.EnumValue.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* EnumValue::release_name() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.EnumValue.name)
  
  return name_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* EnumValue::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.EnumValue.name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void EnumValue::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.EnumValue.name)
}
inline void EnumValue::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      name, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.EnumValue.name)
}
...
inline ::google::protobuf::int32 EnumValue::number() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.EnumValue.number)
  return number_;
}
inline void EnumValue::set_number(::google::protobuf::int32 value) {
  
  number_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.EnumValue.number)
}
...
inline const ::google::protobuf::Option& EnumValue::options(int index) const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.EnumValue.options)
  return options_.Get(index);
}
inline ::google::protobuf::Option* EnumValue::mutable_options(int index) {
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.EnumValue.options)
  return options_.Mutable(index);
}
inline ::google::protobuf::Option* EnumValue::add_options() {
  // @@protoc_insertion_point(field_add:pb.google.protobuf.EnumValue.options)
  return options_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >*
EnumValue::mutable_options() {
  // @@protoc_insertion_point(field_mutable_list:pb.google.protobuf.EnumValue.options)
  return &options_;
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Option >&
EnumValue::options() const {
  // @@protoc_insertion_point(field_list:pb.google.protobuf.EnumValue.options)
  return options_;
}
...
inline const ::std::string& Option::name() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Option.name)
  return name_.Get();
}
inline void Option::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Option.name)
}
inline void Option::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.Option.name)
}
inline void Option::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.Option.name)
}
inline ::std::string* Option::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Option.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Option::release_name() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Option.name)
  
  return name_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* Option::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pb.google.protobuf.Option.name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void Option::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Option.name)
}
inline void Option::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      name, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pb.google.protobuf.Option.name)
}
...
inline const ::google::protobuf::Any& Option::value() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Option.value)
...
inline ::google::protobuf::Any* Option::mutable_value() {
  ...
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.Option.value)
  return value_;
}
inline ::google::protobuf::Any* Option::release_value() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.Option.value)
...
inline  void Option::set_allocated_value(::google::protobuf::Any* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.Option.value)
}
