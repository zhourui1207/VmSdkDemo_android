...
// source: pb.google/protobuf/source_context.proto
...
class LIBPROTOBUF_EXPORT SourceContext : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.SourceContext) */ {
 public:
  SourceContext();
  ...
  // @@protoc_insertion_point(class_scope:pb.google.protobuf.SourceContext)
 private:
...
inline const ::std::string& SourceContext::file_name() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.SourceContext.file_name)
  return file_name_.GetNoArena();
}
inline void SourceContext::set_file_name(const ::std::string& value) {
  
  file_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:pb.google.protobuf.SourceContext.file_name)
}
#if LANG_CXX11
inline void SourceContext::set_file_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:pb.google.protobuf.SourceContext.file_name)
}
#endif
inline void SourceContext::set_file_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:pb.google.protobuf.SourceContext.file_name)
}
inline void SourceContext::set_file_name(const char* value, size_t size) {
  
  file_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:pb.google.protobuf.SourceContext.file_name)
}
inline ::std::string* SourceContext::mutable_file_name() {
  
  // @@protoc_insertion_point(field_mutable:pb.google.protobuf.SourceContext.file_name)
  return file_name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* SourceContext::release_file_name() {
  // @@protoc_insertion_point(field_release:pb.google.protobuf.SourceContext.file_name)
...
inline void SourceContext::set_allocated_file_name(::std::string* file_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pb.google.protobuf.SourceContext.file_name)
}
