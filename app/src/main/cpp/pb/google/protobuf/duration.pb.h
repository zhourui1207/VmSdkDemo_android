...
// source: pb.google/protobuf/duration.proto
...
class LIBPROTOBUF_EXPORT Duration : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.google.protobuf.Duration) */ {
 public:
  Duration();
  virtual ~Duration();
  ...
  // @@protoc_insertion_point(class_scope:pb.google.protobuf.Duration)
 private:
...
inline ::google::protobuf::int64 Duration::seconds() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Duration.seconds)
  return seconds_;
}
inline void Duration::set_seconds(::google::protobuf::int64 value) {
  
  seconds_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Duration.seconds)
}
...
inline ::google::protobuf::int32 Duration::nanos() const {
  // @@protoc_insertion_point(field_get:pb.google.protobuf.Duration.nanos)
  return nanos_;
}
inline void Duration::set_nanos(::google::protobuf::int32 value) {
  
  nanos_ = value;
  // @@protoc_insertion_point(field_set:pb.google.protobuf.Duration.nanos)
}
